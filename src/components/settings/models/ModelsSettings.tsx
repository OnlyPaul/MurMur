          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <div className="relative" ref={languageDropdownRef}>
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium rounded-lg transition-colors ${
                    languageFilter !== "all"
                      ...
                      : "bg-mute/10 text-ink/60 hover:bg-mute/20"
                  }`}
                >
                ...
                {languageDropdownOpen && (
                  <div className="absolute top-full right-0 mt-1 w-56 bg-canvas border border-mute/80 rounded-lg shadow-lg z-50 overflow-hidden">
                    <div className="p-2 border-b border-mute/40">
                      <input
                        ...
                        className="w-full px-2 py-1 text-sm bg-mute/10 border border-mute/40 rounded-md focus:outline-none focus:ring-1 focus:ring-signal"
                      />
                    </div>
                    <div className="max-h-48 overflow-y-auto">
                      ...
                      {filteredLanguages.length === 0 && (
                        <div className="px-3 py-2 text-sm text-ink/50 text-center">
