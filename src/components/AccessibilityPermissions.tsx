...
const AccessibilityPermissions: React.FC = () => {
  ...
  const buttonConfig: Record<PermissionState, ButtonConfig | null> = {
    request: {
      ...
      className:
        "px-2 py-1 text-sm font-semibold bg-mute/10 border  border-mute/80 hover:bg-signal/10 rounded cursor-pointer hover:border-signal",
    },
    verify: {
      text: t("accessibility.openSettings"),
      className:
  ...
  return (
    <div className="p-4 w-full rounded-lg border border-mute">
