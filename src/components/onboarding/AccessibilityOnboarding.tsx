    ...
    <div className="h-screen w-screen flex flex-col p-6 gap-6 items-center justify-center">
      ...
      <div className="max-w-md w-full flex flex-col items-center gap-4">
        ...
        {showMicrophonePermission && (
          <div className="w-full p-4 rounded-lg bg-white/5 border border-mute/20">
            <div className="flex items-center gap-4">
              <div className="p-3 rounded-full bg-signal/20 shrink-0">
                <Mic className="w-6 h-6 text-signal" />
              </div>
              <div className="flex-1 min-w-0">
                ...
                {permissions.microphone === "granted" ? (
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-lg bg-signal hover:bg-signal/90 text-white text-sm font-medium transition-colors"
                  >
                    {isWindows
